...
export default function SearchForm() {
  return (
    <div className="bg-white lg:px-28 sm:px-8 sm:py-9">
      ...
      <form className="grid gap-6 mb-6 md:grid-cols-3">
        ...
        <div>
          <button
            type="button"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-3 px-20 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          >
            Search
          </button>
        </div>
